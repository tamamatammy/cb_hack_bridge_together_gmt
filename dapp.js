...
walletEnable.onclick = async () => {
  ...
  deposit.onclick = async() => {
    const l1_contract = '0x70997970c51812dc3a010c7d01b50e0d17dc79c8'; //todo
    const deposit_value = document.getElementById('deposit-value-box').value;
    var web3 = new Web3(window.ethereum)
    await web3.eth.sendTransaction({
      from:web3.givenProvider.selectedAddress,
      to: l1_contract, 
      value: deposit_value * 10**18,
      gas: 30000
    })
  }
